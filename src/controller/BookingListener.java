...
public class BookingListener implements ActionListener {
    ...
    public BookingListener(JComboBox comboDay, JComboBox comboMonth, JComboBox comboYear, JComboBox comboTime, String type, int partnerID) {
	            ...
	            for (int min = 0; min < 6; min += 2) {
	            	if (avaibilityBoolean[cellValue]) {
		                if (hour == 9) {
		                    ...
		                    comboTime.addItem(String.valueOf(hour) + ":" + String.valueOf(min) + "0");
		                }
	            	}
	            	cellValue++;
	            }
